...
* In Lean
  I have formalized the definition of graph satisfiability in Lean.
  [[file:~/org/website/org/img/graphsat_in_lean.png][Graphsat in Lean]]

  I am working on formalizing some of my results too.
* In Python
* In Haskell
